...
if __name__ == '__main__':
    ...
    for cate in CATEGORY:
        ...
        for light_img, light_feat, bold_img, bold_feat, gt_img, gt_fontname, label in dataloader[cate]:
            ...
            # interpolation
            if APPROACH == 'Noise':
                gen = noise_blend_sampling_ddim(model, light_feat, bold_feat, \
                                                style_scale=SCALE, \
                                                alpha=ALPHA, image_size=IMAGE_SIZE)
            elif APPROACH == 'Condition':
                gen = condition_blend_sampling_ddim(model, light_feat, bold_feat, \
                                                    style_scale=SCALE, \
                                                    alpha=ALPHA, image_size=IMAGE_SIZE)
            elif APPROACH == 'Image':
                gen = image_blend(model, light_feat, bold_feat, light_img, bold_img, \
